...
class ContactFormEntries extends Database
{
    protected Database $db;
    protected string $table = 'wp_contact_form_entries';
    protected array $errors = [];
    protected array $requiredFields = ['firstname', 'lastname', 'email', 'message'];
    ...
    public function save(): bool
    {
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            if ($this->validate()) {
                $sql = "INSERT INTO `{$this->table}` (`firstname`, `lastname`, `email`, `message`) VALUES (:firstname, :lastname, :email, :message)";
